...
synopsis: halOP 0.5.0 brings a rewritten attribute pipeline, resource shell SPI, new documentation site, and a detailed roadmap toward replacing the current WildFly management console.
---
